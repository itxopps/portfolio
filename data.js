...
window.portfolioProfile = {
  ...
  stats: [
    ...
    { value: "12+", label: "NEOM operational sites supported" },
  ...
  impact: [
    ...
    },
    {
      ...
      text: "Smart energy and automation solutions across 13 sites integrating BMS, Robot Shelters , FACP, and IoT-based monitoring."
    },
    {
      ...
      text: "Hardware design, PCB layout, firmware support, Modbus communication, and regulatory documentation for EV infrastructure products."
    }
  ],
  education: [
    {
  ...
  awards: ["Pride of Performance in R&D TESLA INDUSTREIES"]
};
